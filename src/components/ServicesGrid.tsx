      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Complete <span className="text-gradient-primary">Packaging Solutions</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) => {
            return (
              <Card key={index} className="group bg-card/50 backdrop-blur-sm border-border/50 hover:border-primary/30 transition-all duration-500 hover-glow">
                <CardContent className="p-8">
                  {/* Bag Image - First element */}
                  <div className="flex justify-center mb-6">
                    <img 
                      src="/lovable-uploads/b2cf62dc-4fe0-40ba-a71c-f54423d9b53f.png" 
